...
- `Positive Event Hit@10`: 54.13% vs. 19.27% for the SOTA-candidate-only coupon baseline
- `NDCG@10`: 0.3304 vs. 0.1489
- `Recall@10`: 0.4187 vs. 0.1570
- Final artifact: `outputs/reranked_recommendations.csv` generated by top-10-profile tail fusion
